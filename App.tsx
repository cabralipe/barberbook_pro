...
import { MOCK_SHOPS, TIME_SLOTS } from './constants';
...
const App: React.FC = () => {
  ...
  const handleLogin = () => {
    // Simulate login and return to app
    setView('booking');
  };
                ...
                <div className="p-5 flex flex-col flex-1">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide border ${
                      shop.status === 'Aberto' ? 'bg-green-500/20 text-green-500 border-green-500/20' : 
              ...
              {shop.services.map(service => {
                 ...
                 return (
                  <div 
                    ...
                    className={`group relative flex flex-col justify-between rounded-xl border p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md hover:shadow-primary/5 cursor-pointer ${
                      isSelected ? 'bg-primary/5 border-primary ring-1 ring-primary' : 'bg-surface-dark border-border-dark hover:border-primary/50'
                    }`}
                  >
                    ...
                    {TIME_SLOTS.map((time, idx) => {
                       ...
                       return (
                         <button 
                            ...
                            className={`py-2 px-3 rounded-lg border text-sm font-medium transition-all flex flex-col items-center gap-1 group ${
                              isSelected
      ...
      <div className="w-full flex justify-center py-8 px-4 sm:px-6">
        <div className="w-full max-w-[1024px] grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <button onClick={nextStep} className="lg:hidden w-full flex items-center justify-center gap-2 rounded-lg h-12 px-6 bg-primary hover:bg-primary-dark transition-all text-[#181411] text-base font-bold shadow-lg shadow-orange-900/20">
  ...
  if (view === 'login') {
    return <Login onLogin={handleLogin} onRegisterClick={() => setView('register')} />;
  }

  if (view === 'register') {
    return <Register onLoginClick={handleLogin} onRegister={handleRegister} />;
  }
